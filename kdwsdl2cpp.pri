...
kdwsdl_h.name = KDWsdl2Cpp ${QMAKE_FILE_IN}
silent:kdwsdl_h.commands = @echo kdwsdl2cpp ${QMAKE_FILE_IN} && $$kdwsdl_h.commands
QMAKE_EXTRA_COMPILERS += kdwsdl_h

kdwsdl_impl.commands = $$KDWSDL2CPP -impl ${QMAKE_FILE_IN} -o ${QMAKE_FILE_OUT}
...
kdwsdl_impl.depends = $$WSDL_HEADERS_DIR/$${KD_MOD_WSDL}${QMAKE_FILE_BASE}$${first(QMAKE_EXT_H)}
kdwsdl_impl.input = KDWSDL
kdwsdl_impl.variable_out = GENERATED_FILES
kdwsdl_impl.CONFIG += target_predeps
kdwsdl_impl.name = KDWsdl2Cpp ${QMAKE_FILE_IN}
