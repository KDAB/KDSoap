...
from products.ProductConfiguration import ProductConfiguration
...
staticDebug = ProductConfiguration( configName = 'Static Debug', debug = True, shared = False, parent = project )
staticRelease = ProductConfiguration( configName = 'Static Release', debug = False, shared = False, parent = project )
sharedDebug = ProductConfiguration( configName = 'Shared Debug', debug = True, shared = True, parent = project )
sharedRelease = ProductConfiguration( configName = 'Shared Release', debug = False, shared = True, parent = project )
